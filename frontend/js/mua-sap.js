...
function updateCartUI() {
    ...
    if (cartCountElement) {
        const distinctCount = cart.length; // số loại sản phẩm
        cartCountElement.innerText = distinctCount;
    }
...
// Thêm vào đầu file, sau khai báo biến cart
...
// Gọi loadCartFromLocalStorage trong DOMContentLoaded
document.addEventListener('DOMContentLoaded', () => {
    fetchCategories();
    fetchProducts();
    setupUserMenu();
    loadCartFromLocalStorage(); // Thêm dòng này
});